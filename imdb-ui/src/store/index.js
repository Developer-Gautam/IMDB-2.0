...
export const fetchMovies = createAsyncThunk("imdb/trending", async ({ type }, thunkApi) => {
    const { imdb: { genres } } = thunkApi.getState()
...
// return getRawData(`${TMDB_BASE_URL}/discover/${type}?api_key=${API_KEY}&with_genres=${geners}`)
