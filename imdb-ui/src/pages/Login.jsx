        ...
        <div className="form-container flex a-center j-center">
          <div className="form flex column a-center j-center">
            ...
            <div className="container flex column">
              ...
              <input type="password" placeholder='Set a password' name='password' value={formValues.password} onChange={(e) => setFormValues({ ...formValues, [e.target.name]: e.target.value })} />
